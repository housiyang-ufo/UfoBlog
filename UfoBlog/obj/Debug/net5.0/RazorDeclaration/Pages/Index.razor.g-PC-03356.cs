...
#nullable disable
#nullable restore
#line 2 "C:\Users\40157\OneDrive\Documents\UfoBlog\UfoBlog\Pages\Index.razor"
...
#nullable restore
#line 15 "C:\Users\40157\OneDrive\Documents\UfoBlog\UfoBlog\Pages\Index.razor"
      
    private static List<NavTar> navs = new List<NavTar>()
    {
        new NavTar{ Title="主页", Icon="home", Url="" },
        new NavTar{ Title="博客", Icon="book", Url="" },
        new NavTar{ Title="关于我", Icon="user", Url="" },
    };

    private string Selected { get; set; } = navs.FirstOrDefault().Icon;
